...
| [BLAST/RBH 同源映射架构](pichia_homology_crosswalk_architecture.md) | 酿酒酵母到 Pichia 的离线同源证据层实现、external name cache builder、cache/service/UI 入口，以及 Streamlit 命名/规则迁移审计边界 |
