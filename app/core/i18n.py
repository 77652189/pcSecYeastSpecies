...
SIMULATION_RESULT_COLUMN_LABELS = {
    ...
    "interpretation": "解读",
    # 全基因组 KO/OE 筛查维度表 + 运行记录表 + fact pack
    "gene_id": "基因",
    "gene_display_name": "基因名",
    "standard_symbol": "标准符号",
    "protein_name": "蛋白名",
    "annotation_confidence": "注释置信度",
    "standard_name_status": "命名状态",
    "annotation_tier": "名字类型",
    "annotation_accession": "数据库 ID（可自查）",
    "identity_review": "身份复核",
    "common_name": "常用名",
    "candidate_kind": "候选类型",
    "affected_reactions": "涉及反应",
    "intervention_type": "干预类型",
    "max_feasible_mu": "最大可行生长速率",
    "secretion_ratio_vs_wildtype": "分泌比值(vs 野生型)",
    "growth_retention_ratio": "生长保持率",
    "gpr_role": "GPR 角色",
    "feasibility_interpretation": "可行性判定",
    "has_timeout": "是否超时",
    "timeout_mu_points": "超时的生长速率点",
    "proven_infeasible_mu_points": "证明不可行的生长速率点",
    "other_solver_failure_mu_points": "其它求解失败的生长速率点",
    "solver_retry_count": "求解重试次数",
    "timeout_retry_mu_points": "重试仍超时的生长速率点",
    "skipped_reason": "跳过原因",
    "divergence": "靶点间差异",
    "run_name": "运行名",
    "candidate_count": "候选数",
...
SIMULATION_RESULT_VALUE_LABELS = {
    ...
    "generic_annotation": "泛化注释（自动注释，无功能结论）",
    "no_annotation": "无注释（仅模型位点）",
    "high_exact_locus_tag": "位点号精确匹配外部库",
    "medium_exact_kegg_locus_tag": "位点号精确匹配 KEGG",
    "low_model_only": "仅模型内部，无外部注释",
    "annotated": "已注释",
    "model_only": "仅模型位点",
    "not_gene_candidate": "非基因候选（反应级）",
    "missing_standard_name": "无标准命名记录",
    "curated_identity_unverified": "⚠ 身份待复核（俗名对应未坐实）",
    ...
    # 筛查维度表 / 运行记录表枚举值
    "gene": "基因",
    "catalog_reaction": "策展反应",
    "complex_oe_hypothesis": "复合体整体过表达假设",
    "single_gene": "单基因",
    "complex_subunit": "复合体亚基",
    "isoenzyme": "同工酶",
    "mixed": "混合",
    "catalog_curated": "策展复合体反应",
    "KO": "敲除(KO)",
    "OE": "过表达(OE)",
    "definitive": "确定",
    "inconclusive_due_to_timeout": "超时未定",
    "inconclusive_due_to_solver_failure": "求解失败未定",
    "starting": "启动中",
    "running": "运行中",
    "done": "已完成",
    "fast": "快速",
